...
# Configuración para conectarse al clúster de Redis
try:
    startup_nodes = [
    ...
    logging.error(f"Error al conectar con el clúster de Redis: {e}")
    ...
    def GetTasterInfo(self, request, context):
        ...
        try:
            ...
            if taster_name:
                ...
                return wine_pb2.TasterResponse(tasterName=taster_name, fromCache=True)
